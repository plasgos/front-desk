  ...
  return (
    <div>
      <div className="container-fluid p-3 d-flex justify-content-end border-bottom ">
        <CButton color="primary">Cetak</CButton>
      </div>
          ...
          <div className="border border-dark">
            ...
            >
              <div>
                ...
                <div className="mb-2">John Doe</div>089721231 | Jl. Blotan
                Permai No.23 RT 03/40 Jakarta Tmimur
              </div>
              <div>
            ...
            <div className="d-flex justify-content-between p-3 border-bottom">
              <div>
                ...
                <div>
                  ...
                  adipisicing elit. Quisquam, impedit.
                </div>
              </div>
              <div>
