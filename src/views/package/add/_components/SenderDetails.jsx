...
const Card = () => {
  ...
  return (
    <div className="card p-3 shadow-sm rounded">
      ...
      <div>{sender.address} {sender.Subdistrict.name} {sender.Subdistrict.City.type} {sender.Subdistrict.City.name} {sender.Subdistrict.City.Province.name}, {sender.postal_code}</div>
    </div>
  )
}
const SenderDetails = () => {
