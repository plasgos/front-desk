...
import { setShipping } from "../../../../modules/package/reducer";
        ...
        <form>
          <div className="form-row">
            <div className="form-group col-md-6 mb-0">
              <div
                className={`card my-2 px-3 py-2 shadow-sm ${
                  drop === false && "border border-primary"
                }`}
              >
                <Checkbox
                  checked={drop === false}
                  onClick={() => onSetDrop(false)}
                  size={18}
            ...
            <div className="form-group col-md-6 mb-0 ">
              <div
                className={`card my-2 px-3 py-2 shadow-sm ${
                  drop && "border border-primary"
                }`}
              >
                <Checkbox
                  checked={drop}
                  onClick={() => onSetDrop(true)}
                  size={18}
                  style={{ cursor: "pointer", transform: "scale(1.2)" }}
                  label="Drop Off"
                  labelStyle={{ fontSize: 18 }}
        ...
        <div className="mt-2">
          <CAlert color="info" className="m-0">
            <div className="d-flex align-items-center justify-content-start">
              <div className="mr-3">
                <IoInformationCircleOutline style={{ fontSize: 28 }} />
              </div>
              {drop ? (
                <div style={{ fontSize: 15 }}>
                  Paket ini harus <b>DIANTARKAN</b> ke agen ekspedisi yang
                  dipilih pembeli
                </div>
              ) : (
                <div style={{ fontSize: 15 }}>
