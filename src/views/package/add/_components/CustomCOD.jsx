...
import { setShipping, setError } from '../../../../redux/modules/package/reducer';
...
export default () => {
  ...
  const { error, shipping_cost, cod_fee, insurance_fee, item_value, shipping } = useSelector((state) => state.package);
        ...
        <div className="card py-2 px-3 shadow-sm">
          ...
          <form>
            <div className="form-group mb-0">
              ...
              <input value={cod_value} onChange={(e) => onChangeCodValue(e.target.value)} onBlur={onBlurCodValue} className="form-control " />
            </div>
          </form>
        </div>
    </>
