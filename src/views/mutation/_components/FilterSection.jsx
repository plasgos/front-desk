    ...
    <div className="shadow-sm  p-3 mt-3">
      ...
      >
        <div style={{ flexGrow: 1 }}>
          <CLabel className="font-weight-bold">Order ID / AWB</CLabel>
          <CInput
            value={invoice}
        ...
        <div>
          <div className="font-weight-bold">Filter Berdasarkan</div>
        ...
        <div>
          <div className="font-weight-bold">Urutkan Berdasarkan</div>
          <CDropdown className="mt-2">
            <CDropdownToggle
              style={{ width: 200 }}
              caret
