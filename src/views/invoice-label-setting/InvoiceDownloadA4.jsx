...
const InvoiceDownloadA4 = ({ isSelectedA6, isSelectedA4 }) => {
            ...
            >
              <View style={{ border: 0.5 }}>
                ...
                <View style={{ padding: 10, paddingBottom: 5 }}>
                  ...
                  >
                    <View>
                      <Text style={{ fontSize: 10 }}>Jenisa Layanan : REG</Text>
                    </View>
                ...
                >
                  ...
                  <View>
                    ...
                    <Text style={{ fontSize: 8, marginBottom: 2 }}>1 Pcs</Text>
                  </View>
                </View>
...
export default InvoiceDownloadA4;
